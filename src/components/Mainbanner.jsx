    ...
    <div className='w-280 h-[400px] mt-3 ml-25'>
       ...
       <div className='absolute mt-3 w-[755px] h-[380px] px-10 ml-58'>
        ...
        <div className='absolute mt-3 bg-blue-100 w-[170px] rounded ml-238 h-35 my-2'>
            ...
            <button className='btn-primary rounded bg-blue-500 h-6 w-[150px] ml-3 absolute mt-18 text-white text-sm'>Join now</button>
            <button className='btn-primary rounded bg-zinc-100 h-6 text-blue-500 text-sm w-[150px] ml-3 absolute mt-26'>Login</button>
        </div>
